...
describe('Validate TS configs', () => {
  it('Validate hansy-f2e-eslint-config/typescript', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/typescript/vue', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/typescript', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/typescript/react', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/typescript/vue', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/typescript/node', async () => {
