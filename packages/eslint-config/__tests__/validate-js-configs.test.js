...
describe('Validate JS configs', () => {
  it('Validate hansy-f2e-eslint-config', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/es5', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/vue', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/es5', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/react', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/essential/vue', async () => {
  ...
  it('Validate hansy-f2e-eslint-config/node', async () => {
